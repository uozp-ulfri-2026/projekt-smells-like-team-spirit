...
::: {layout="[[50,50]]"}
![Slika 1a: Heatmap](assets/images/01a-heatmap.png)

![Slika 1b: Pike s sidebari](assets/images/01b-dots-w-sidebars.png)

Slika 1: Globalna pokritost (heatmap) in lokalna natančnost poročanja (pike).
:::
...
::: {layout="[[50,50]]"}
![Slika 2a: Vojna – Ukrajina](assets/images/02a-war-ukraine.png)

![Slika 2b: Vojna – Bližnji vzhod](assets/images/02b-war-palestine.png)

Slika 2: Tema "vojna & konflikti" razkrije dve geografsko ločeni žarišči.
:::
...
::: {#fig:economy}
![Slika 3: Ekonomija](assets/images/03-economy.png)

Tematski filter "gospodarstvo" – opazna redkost zunaj tradicionalnih ekonomskih središč.
:::
